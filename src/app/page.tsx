    ...
    <>
      <Container className="mt-24 sm:mt-32 md:mt-56">
        <FadeIn className="max-w-3xl">
          ...
          Join our community of top sports handicappers and boost your bankroll.
          </p>
          <Button className="mt-6 bg-[#00C81F] hover:bg-[#00c81ec5]" href="https://whop.com/emerald-betz/">
            Join Now
          </Button>
        </FadeIn>
      </Container>
